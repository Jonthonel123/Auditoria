...
<nav  class="navbar navbar-expand-lg navbar-dark menu-navegacion fixed-top bg-dark">
  <div class="container">
  <a class="navbar-brand" href="#">Auditores SGI</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto ">
      <!-- mr-auto ->poner nav ala izquierda & ml-auto -> ala derecho -->
      <li class="nav-item">
