...
<div class="page-content-wrap" style="padding: 15px">
            ...
            <div class="panel-body">
                <div class="panel-body">
                    ...
                    <form name="form_busqueda" id="form_busqueda" method="post" action="<?php
                                                                                        echo site_url($this->config->item('path_backend') . '/Area_Responsable/buscar');
                                                                                        ?>">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="area" maxlength="255" class="form-control input" type="text" name="area" placeholder="Area" value="<?php echo $area; ?>" class="input-small" />
                            </div>

                            <div class="col-md-6">
                                <label class="control-label">Responsable</label>
                                <input id="responsable" maxlength="255" class="form-control input" type="text" name="responsable" placeholder="Responsable" value="<?php echo $responsable; ?>" class="input-small" />
                            </div>
    ...
    <div class="panel panel-default" style="border-top-color: #DAD4D4 ; border-top-width : 2px">
        <div class="panel-heading">
            ...
            <a href="<?php echo site_url($this->config->item('path_backend') . '/Area_Responsable/agregar'); ?>" class="btn btn-default pull-right"><i class="fa fa-plus"></i> Agregar</a>
                    ...
                    if (isset($areas) && count($areas) > 0) {
                        ...
                        foreach ($areas as $item) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo site_url($this->config->item('path_backend') . '/Area_Responsable/editar/' . $item->id); ?>" class="btn btn-info btn-condensed" title="Editar"><i class="fa fa-edit"></i></a>
                                </td>
