...
##############################CONTANTES API#################################
define('URL_HOST_IMAGENES', 'http://localhost/vikingo/');
...
define('CORREO_NOMBRE','cjuyotest@gmail.com');
define('CORREO_CONTRASENIA','$<$test$>$');

define('REMITENTE_NOMBRE','Nombre de Remitente');
