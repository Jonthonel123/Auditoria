$(function(){        
    ...
    var rdc = new Rickshaw.Graph( {
            element: document.getElementById("api-dashboard-chart"),
            renderer: 'area',
            width: $("#api-dashboard-chart").width(),
            height: 250,
    ...
    var legend = new Rickshaw.Graph.Legend({graph: rdc, element: document.getElementById('api-dashboard-legend')});
    ...
    var rdc_resize = function() {                
            rdc.configure({
                    width: $("#api-dashboard-chart").width(),
                    height: $("#api-dashboard-chart").height()
            });
            rdc.render();
    }
    ...
    rdc_resize();
    /* END Rickshaw api-dashboard chart */
    
    /* Donut api-dashboard chart */
    Morris.Donut({
        element: 'api-dashboard-donut-1',
        data: [
    ...
    /* END Donut api-dashboard chart */
    
    /* Bar api-dashboard chart */
    Morris.Bar({
        element: 'api-dashboard-bar-1',
        data: [
            { y: 'Oct 10', a: 75, b: 35 },
            { y: 'Oct 11', a: 64, b: 26 },
            { y: 'Oct 12', a: 78, b: 39 },
    ...
    /* END Bar api-dashboard chart */
    
    /* Line api-dashboard chart */
    Morris.Line({
      element: 'api-dashboard-line-1',
      data: [
    ...
    /* EMD Line api-dashboard chart */
    
    /* Vector Map */
    var jvm_wm = new jvm.WorldMap({container: $('#api-dashboard-map-seles'),
                                    map: 'world_mill_en', 
